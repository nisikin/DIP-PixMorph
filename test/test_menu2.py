...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QLabel, QPushButton,
                             QFileDialog, QComboBox, QHBoxLayout, QVBoxLayout, QGroupBox,
                             QMessageBox)
...
class ImageConverterApp(QMainWindow):
    ...
    def initUI(self):
        self.effect_options = {
            "灰度化": ["灰度化"],
            "二值化": ["二值化", "反二值化"],
            "图像平滑": ["均值滤波", "中值滤波","理想低通滤波","巴特沃斯低通滤波","高斯低通滤波"],
            "图像锐化": ["Roberts算子", "Sobel算子","Prewitt算子","Laplacian算子","理想高通滤波","巴特沃斯高通滤波","高斯高通滤波"],
            "绘制直方图": ["绘制直方图"],
            "直方图均衡化": ["对数变换","均衡化","正规化"],
